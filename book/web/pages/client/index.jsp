...
<title>书城首页</title>
	...
	<script type="text/javascript">
		$(function () {
			...
			// 	$.getJSON("http://localhost:8080/book/cartServlet","action=ajaxAddItem$"+bookId,function (data) {
...
<body>
	...
	<div id="header">
			...
			<div>
				...
				<c:if test="${not empty sessionScope.user}">
					<span>欢迎<span class="um_span">${sessionScope.user.username}</span>光临花书城</span>
	...
	<div id="main">
		<div id="book">
			<div class="book_cond">
				<form action="/book/client/bookServlet?action=queryBooksByPrice" method="post">
